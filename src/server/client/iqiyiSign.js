...
function(t, e, n) {
  ...
  v = function() {
      ...
      t.prototype.connectSocket = function() {
          ...
          o = p["default"].instance.getIsHttps()
          ? "wss://" + p["default"].instance.getCurrentIp() + "/ws?" + p["default"].instance.getPath(n) 
          : 1 === p["default"].instance.type || 2 === p["default"].instance.type && p["default"].instance.getIsDev()
          ? "ws://" + p["default"].instance.getCurrentIp() + ":7533/ws?" + p["default"].instance.getPath(n) 
          : "ws://" + p["default"].instance.getCurrentIp() + "/ws?" + p["default"].instance.getPath(n),
...
const init = function(t) {
  ...
  e.p = "/";
  return e(100).default.prototype.sg
}
// 由一下参数计算签名
// {
//   v: '2.05.2801',
...
//   n: 1,
//   r: 213343,
//   d: '97b675b61dcc472c3d92197856de0f31',
//   at: 2,
//   ak: '9cXoAcgDAouOMVihGZ90cbXvjFB4IWwedy9T53uuKjZm2Ne6oKv8m2ciZIwTNLMkl2kNb4',
//   ag: 1
// }

export default init(funcs)
